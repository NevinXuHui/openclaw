...
x-i18n:
  sourceCommit: "latest"
  sourceFile: "install/oracle.md"
---

# Oracle Cloud

在 Oracle Cloud 的 **Always Free** ARM 层（最多 4 OCPU、24 GB RAM、200 GB 存储）上免费运行持久的 OpenClaw Gateway 网关。
...
<Steps>
  ...
  <Step title="配置 gateway">
    使用 token 认证和 Tailscale Serve 进行安全远程访问。
